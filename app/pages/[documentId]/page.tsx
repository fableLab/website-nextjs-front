...
export default function Page() {
  ...
  //const APIURL = 'https://strapi.fable-lab.org/api/pages/${documentId}?populate[contents][populate]=*';
  // const APIURL_LOCALHOST = http://localhost:1337/api/pages/${documentId}?populate[contents][populate]=*';
